...
On the other hand, MPC is far more resource-demanding than LQR. \todo {from this point is bad} Also, the solution using MPC is usually not optimal in the context of the cost function (as mentioned above, it optimizes with respect to stability or other metrics). Another downside to MPC is that it requires a model of the system, while LQR does not.
