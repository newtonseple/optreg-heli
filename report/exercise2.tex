...
\end{lstlisting}
The weight matrix Q was generated using the function \texttt{genq2}, and c is a vector of zeros. Aeq was generated using the function \textt{gena2}, while beq is a vector of zeros. The constraints on the inputs were implemented using the given function \textt{genbegr2}.
...
The Simulink implementation is shown below. Zeros were added before and after the optimal input sequence. For the full Matlab code, see the Appendix.\todo{make actual reference}
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{E24_Cosmetic}}
