...
\end{lstlisting}
The weight matrix \texttt{Q} was generated using the function \texttt{genq2}, and c is a vector of zeros. Aeq was generated using the function \texttt{gena2}, while beq is a vector of zeros. The constraints on the inputs were implemented using the given function \textt{genbegr2}.
