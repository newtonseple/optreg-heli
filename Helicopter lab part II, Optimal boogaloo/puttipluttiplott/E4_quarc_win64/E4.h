 ...
 */
#ifndef RTW_HEADER_E4_h_
#define RTW_HEADER_E4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef E4_COMMON_INCLUDES_
# define E4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#define E4_rtModel                     RT_MODEL_E4_T
...
typedef struct {
  ...
  real_T TmpSignalConversionAtToFileInpo[16];
  real_T Sum_k;                        /* '<S5>/Sum' */
  real_T Sum2;                         /* '<S3>/Sum2' */
  real_T K_ei;                         /* '<S3>/K_ei' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Massivescope_PWORK;                /* '<Root>/Massive scope' */
  ...
  struct {
    void *LoggedData;
  } eande_ref_PWORK;                   /* '<Root>/e and e_ref' */
...
#define rtB                            E4_B
#define BlockIO                        B_E4_T
#define rtX                            E4_X
#define ContinuousStates               X_E4_T
#define rtXdot                         E4_XDot
#define StateDerivatives               XDot_E4_T
#define tXdis                          E4_XDis
#define StateDisabled                  XDis_E4_T
#define rtP                            E4_P
#define Parameters                     P_E4_T
#define rtDWork                        E4_DW
#define D_Work                         DW_E4_T

/* Parameters (auto storage) */
struct P_E4_T_ {
  real_T K[12];                        /* Variable: K
                                        * Referenced by: '<Root>/LQR'
                                        */
...
extern DW_E4_T E4_DW;

/* Model entry point functions */
extern void E4_initialize(void);
extern void E4_output(void);
extern void E4_update(void);
extern void E4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_E4_T *const E4_M;
 ...
 * '<Root>' : 'E4'
 * '<S1>'   : 'E4/Conversion'
 * '<S2>'   : 'E4/Degrees to Radians'
 * '<S3>'   : 'E4/Elevation controller'
 * '<S4>'   : 'E4/Helicopter_interface'
 * '<S5>'   : 'E4/Pitch controller'
 * '<S6>'   : 'E4/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'E4/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'E4/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'E4/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'E4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'E4/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'E4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_E4_h_ */
