 ...
 */
#ifndef RTW_HEADER_E2d_h_
#define RTW_HEADER_E2d_h_
#include <math.h>
#include <string.h>
#ifndef E2d_COMMON_INCLUDES_
# define E2d_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#define E2d_rtModel                    RT_MODEL_E2d_T
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator;       /* '<S3>/Discrete-Time Integrator' */
...
#define rtB                            E2d_B
#define BlockIO                        B_E2d_T
#define rtX                            E2d_X
#define ContinuousStates               X_E2d_T
#define rtXdot                         E2d_XDot
#define StateDerivatives               XDot_E2d_T
#define tXdis                          E2d_XDis
#define StateDisabled                  XDis_E2d_T
#define rtP                            E2d_P
#define Parameters                     P_E2d_T
#define rtDWork                        E2d_DW
#define D_Work                         DW_E2d_T
...
struct P_E2d_T_ {
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S4>/Integrator'
                                        */
  real_T elevation_ref_Value;          /* Expression: 0.0
...
extern P_E2d_T E2d_P;

/* Block signals (auto storage) */
extern B_E2d_T E2d_B;

/* Continuous states (auto storage) */
extern X_E2d_T E2d_X;

/* Block states (auto storage) */
extern DW_E2d_T E2d_DW;

/* Model entry point functions */
extern void E2d_initialize(void);
extern void E2d_output(void);
extern void E2d_update(void);
extern void E2d_terminate(void);

/* Real-time Model object */
extern RT_MODEL_E2d_T *const E2d_M;
 ...
 * '<Root>' : 'E2d'
 * '<S1>'   : 'E2d/Conversion'
 * '<S2>'   : 'E2d/Degrees to Radians'
 * '<S3>'   : 'E2d/Elapsed Time'
 * '<S4>'   : 'E2d/Elevation controller'
 * '<S5>'   : 'E2d/Helicopter_interface'
 * '<S6>'   : 'E2d/Pitch controller'
 * '<S7>'   : 'E2d/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'E2d/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'E2d/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'E2d/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'E2d/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'E2d/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'E2d/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_E2d_h_ */
