 ...
 * '<S3>'   : 'E2d/Elevation controller'
 * '<S4>'   : 'E2d/Helicopter_interface'
 * '<S5>'   : 'E2d/Pitch controller'
 * '<S6>'   : 'E2d/Helicopter_interface/Elevation rad to deg'
 * '<S7>'   : 'E2d/Helicopter_interface/Elevation rate rad to deg'
 * '<S8>'   : 'E2d/Helicopter_interface/Pitch rad to deg'
 * '<S9>'   : 'E2d/Helicopter_interface/Pitch rate rad to deg'
 * '<S10>'  : 'E2d/Helicopter_interface/Pitch rate rad to deg1'
 * '<S11>'  : 'E2d/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'E2d/Helicopter_interface/Travel rate  rad to deg'
 */
